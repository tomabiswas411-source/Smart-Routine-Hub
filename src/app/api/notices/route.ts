...
export async function POST(request: NextRequest) {
  try {
    ...
    // Both Teachers and Admins can create approved notices directly
    // This allows teachers to post department notices without waiting for approval
    ...
    const noticeData: Record<string, any> = {
      ...
      isApproved: true, // Auto-approve all notices from teachers and admins
